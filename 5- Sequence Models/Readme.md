...
- In the word embeddings task, we are learning a representation for each word in our FIX vocabulary (unlike in image encoding where we have to map  any new image to some n-dimensional vector). We will discuss the algorithm in next sections.
